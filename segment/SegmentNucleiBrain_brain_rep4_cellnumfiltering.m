...
zoffset_RNA = [0 0 0 0 0 0 0 0]; % manually added if necessary.
date = 20191207;
path_seg = 'G:\Yodai\DNA+\2019-11-04-brain-rep4-1-DNAFISHIF\3d nuclear segmentation';
path_dna = 'G:\Yodai\DNA+\2019-11-04-brain-rep4-1-DNAFISHIF\analysis\';
path_rna = 'G:\Yodai\DNA+\2019-10-27-brain-rep4-1-RNAFISH\analysis\';
exp = 'brain-rep4-1';
exp_dna = '2019-11-04-brain-rep4-1-DNAFISH';
exp_rna = '2019-10-27-brain-rep4-1-RNAFISH';
...
for pos = 0:7
    ...
    DAPI = [path_seg '\Pos' num2str(pos) '\C2-alignedcorrected-Pos' num2str(pos) '_binned_DAPI_Probabilities5.h5'];
