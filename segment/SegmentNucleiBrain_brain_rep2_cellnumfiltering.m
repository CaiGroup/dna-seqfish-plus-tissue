...
exp = 'brain-rep2-2';
exp_dna = '2019-09-09-brain-rep2-2-DNAFISH';
exp_rna = '2019-09-04-brain-rep2-2-RNAFISH';
...
for pos = 0:4
    ...
    listing_ch1 = dir([path_dna '2error-sqrt6-ch1\data-' exp_dna '-Pos*.mat']);
    listing_ch2 = dir([path_dna '2error-sqrt6-ch2\data-' exp_dna '-Pos*.mat']);
    for ch = 1:2
        savePathCh_dna = fullfile([path_dna 'DNA_3dRoiNuc-' num2str(date)], [exp '-DNAFISHdecoded-ch' num2str(ch) '-Pos' num2str(pos) '-' num2str(date) '.mat']);
        if ch == 1
