...
% Author: Nico Pierson
    ...
    if isempty(removePoints) && isempty(dotlocations)
        ...
        [points] = processpoints(experimentDir, experimentName, position, ...
            numRounds, numChannels, sqrtradius, alloweddiff, processedImages, ...
            typedots, superresolve, channel, multiplier, adjustedthreshold);
    else
