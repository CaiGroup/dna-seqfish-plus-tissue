% Make functiont to get the points from each of the processed images
%
...
save(fullfile(pwd, ['hyb-points-0_80-ForBeadAlignment-pos' num2str(position) '-radialcenter3d.csv']), 'points', 'intensity', 'position', 'backTform', ...
    'shadingcorr');

listSavePath = fullfile(pwd, ['hyb-points-0_80-ForBeadAlignment-pos' num2str(position) '-radialcenter3d.csv']);
