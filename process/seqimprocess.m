...
% Author: Nico Pierson
    ...
    saveFileNameEnd = [experimentName '-Pos' num2str(position) '-' endingDateString];
    ...
    % folders
    [points, threshold] = detectdotsperhybcycle(experimentDir, processedImages, folderArray, channelArray, typedots, superresolve, pointsSavePath);
    ...
    for c = 1:numCells
        for f = 1:numHybs
            for ch = 1:numChannels
                numPoints = size(pointspercell{c}{f}.channels,1);
                for p = 1:numPoints
