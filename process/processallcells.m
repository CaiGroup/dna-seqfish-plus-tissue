...
% Author: Nico Pierson
    ...
    if numvarargs == 1 
        ...
        elseif ~strcmp(varargin{1}, 'roi') && ~strcmp(varargin{1}, '3d')
            error('myfun:processallcells:WrongInput', ...
                'processallcells var segment requires type string: "roi" or "3d"');
        end
    end
    if numvarargs > 1
    ...
    [segment, sqrtradius, alloweddiff, saveoption, explabel, minseeds] = optargs{:};
    ...
    savePath = fullfile(projectDir, analysisFolder, explabel);
