...
% Author: Nico Pierson
    ...
    [typedots, superresolve, channel, multiplier] = optargs{:};
    ...
    points = detectdotsperbarcodev3(processedImages, threshold, numRounds, numChannels, typedots, superresolve, pointsSaveDir, multiplier);
