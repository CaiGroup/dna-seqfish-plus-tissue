function [] = printfovcsv(finalPosList, fileName)
...
roundFinalPosList = cellfun(@removezeros, finalPosList, 'UniformOutput', false);
...
strFinalPosList(2:end, 2:end) = cellfun(@mat2str, roundFinalPosList(2:end, 2:end), 'UniformOutput', false);
...
% Write to csv
cell2csv(fileName, strFinalPosList);