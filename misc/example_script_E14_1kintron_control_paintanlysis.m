...
experimentDir = 'G:\Yodai\DNA+\2020-01-24-E14-1kintron-IF\organized RNA folder';
experimentName = '2020-01-24-E14-1kintron';
experimentLabel = '2020-02-21-seqential-analysis-logradial3d';
posArray = 0:4;
folderArray = 0;
numCh = 2;
chArray = 1:numCh;
fiducialhybArray = 3:4; %starting from 1, should be last 2 images.
% import chaTform
load(fullfile(experimentDir,'analysis',experimentLabel,'points','variables','refpoints-chromaticaberrations-initial-final-2020-02-21.mat'),'chaTformFinal');
